...
public class jsonReader {
    ...
    public static Composition fromJSON(String fileName) {
        ...
        try {
            ...
            System.out.println("Something went wrong, in jsonReader.fromJSON");
        }
    ...
    public static Vector2 toVec2(String point)
    {
        String[] coordinates = point.split("\\,\\ ");
        return new Vector2(Integer.parseInt(coordinates[0]), -Integer.parseInt(coordinates[1]));
    }
